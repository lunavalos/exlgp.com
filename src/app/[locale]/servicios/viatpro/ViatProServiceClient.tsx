...
export default function ViatProServiceClient() {
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <motion.div
            ...
            className="p-8 lg:p-10 bg-[#08094d] text-white rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl"
          >
            ...
            {wmsFeatures.map((wms, idx) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5, delay: idx * 0.08 }}
                  className="bg-slate-50 border border-slate-200/90 rounded-3xl p-6 shadow-sm flex items-start gap-5"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="lg:col-span-5 bg-gradient-to-br from-[#0D0E9F] to-[#08094d] text-white p-8 lg:p-10 rounded-3xl shadow-xl space-y-6"
            >
